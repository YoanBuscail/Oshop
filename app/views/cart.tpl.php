                        ...
                        <div class="cart-body">
                            ...
                            <div class="cart-item">
                                <div class="row d-flex align-items-center text-center">
                                    <div class="col-5">
                                        <div class="d-flex align-items-center"><a href="detail.html"><img src="<?= $asoluteUrl ?>/assets/images/produits/1-kiss_tn.jpg" alt="..." class="cart-item-img"></a>
                            ...
                            <div class="cart-item">
                                <div class="row d-flex align-items-center text-center">
                                    <div class="col-5">
                                        <div class="d-flex align-items-center"><a href="detail.html"><img src="<?= $asoluteUrl ?>/assets/images/produits/13-unicorn_tn.jpg" alt="..." class="cart-item-img"></a>
